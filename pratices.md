...
- Tests
    - Minimiser les tests e2e et les tests d'intégration
      ...
      - FJ > Je pense que pour l'instant on n'a pas trouvé une bonne stratégie de test pour les tests E2E ne soient pas fragiles, ni maitrisable (avec Cypress en tout cas, on ne peut pas changer l'injection de dépendence)
...
- Méthodologie
    ...
    - Linter/Prettier 
      ...
      - FJ > J'comprends pas trop ce qui dérange, avec un IDE correctement configuré, c'est transparent. On peut peut-être revoir certaines règles cependant, si elles nous gênent.
- Testing
...
- A part
    - pour le futur, mettre en place l'event sourcing et devenir expert dessus
      ...
      - FJ > C'est bien à connaitre, mais c'est vraiment pas une réponse à tous les problèmes. Ça génère un overhead énorme alors que ça n'a d'intérêt que dans les produits hyper coûteux en ressource
